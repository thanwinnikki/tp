...
public class Person {
    ...
    /**
     * Returns true if both persons have the same name and false otherwise.
    ...
    /**
     * Returns true if both persons have the same identity and data fields and false otherwise.
