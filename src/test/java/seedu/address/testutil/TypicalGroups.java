...
public class TypicalGroups {
    ...
    public static final GroupBuilder CS2103T_GROUP_BUILDER = new GroupBuilder().withName("CS2103T Project Group")
            .withMembers(ALICE, BENSON, CARL).withTasks(TASK_A, TASK_B, TASK_E);
